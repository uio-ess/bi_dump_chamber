...
pipe = pipe.translate((0,0,-plate_thickness))
...
lamp_array_x_spacing = 100
lamp_array_z_spacing = 50
#lamp_array_y_shift = post_y_offset_from_center-clamp_plate_face_offset
lamp_array_y_shift = - 100
lamp = lampa.translate((-lamp_array_x_spacing,0,lamp_array_z_spacing))
...
lamp_cpnd = lamp_cpnd.translate((0,lamp_array_y_shift,clamp_along_post))
...
if 'show_object' in locals():
    show_object(bot_mirror_cpnd)
    show_object(bot_plate)
    show_object(bot_base_cpnd)

# write the output stepfiles
output_folder = "output"
out_filename = "top_mirror.step"
cq.exporters.export(top_mirror_cpnd, output_folder+'/'+out_filename, cq.exporters.ExportTypes.STEP)
out_filename = "pipe.step"
cq.exporters.export(pipe, output_folder+'/'+out_filename, cq.exporters.ExportTypes.STEP)
out_filename = "lamp_cpnd.step"
cq.exporters.export(lamp_cpnd, output_folder+'/'+out_filename, cq.exporters.ExportTypes.STEP)
out_filename = "top_base_cpnd.step"
cq.exporters.export(top_base_cpnd, output_folder+'/'+out_filename, cq.exporters.ExportTypes.STEP)
out_filename = "top_plate.step"
cq.exporters.export(top_plate, output_folder+'/'+out_filename, cq.exporters.ExportTypes.STEP)
out_filename = "bot_mirror_cpnd.step"
cq.exporters.export(bot_mirror_cpnd, output_folder+'/'+out_filename, cq.exporters.ExportTypes.STEP)
out_filename = "bot_plate.step"
cq.exporters.export(bot_plate, output_folder+'/'+out_filename, cq.exporters.ExportTypes.STEP)
out_filename = "bot_base_cpnd.step"
cq.exporters.export(bot_base_cpnd, output_folder+'/'+out_filename, cq.exporters.ExportTypes.STEP)
